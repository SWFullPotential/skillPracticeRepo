...
Window.prototype.tabClose = function (index) {
  ...
  var removedTabs = this.tabs.splice(index, 1);
  // this way we can still store the tabs that have been removed if we need to access them later.
